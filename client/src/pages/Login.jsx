...
export default function Login() {
  ...
  return (
    <div className="page" style={{ maxWidth: 420 }}>
      <div className="page-card">
        <div className="page-header"><h2>Login</h2></div>
        <div className="page-body">
          ...
          <form onSubmit={handleSubmit}>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              ...
              <label style={{ display: 'flex', alignItems: 'center', color: '#1a73e8', marginTop: '10px' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#1a73e8" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ marginRight: '8px' }}>
              ...
              <button disabled={loading} type="submit" className="translate-btn-main" style={{ width: '100%', marginTop: 12 }}>{loading ? 'Logging in...' : 'Login'}</button>
            </div>
          </form>
